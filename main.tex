...
\definecolor{azzurro}{rgb}{0.0, 0.53, 0.74}
\usepackage{makeidx}
\usepackage[dvipsnames]{xcolor}
\usepackage{hyperref} % Used to generate the index
\hypersetup{colorlinks=true,linkcolor=azzurro,urlcolor=azzurro}
...
\title{\qquad \quad \ Appunti di\\ \quad Fisica Nucleare} % Title of the book
...
\chapter{I primi modelli nucleari}\label{ch:modelli-nucleari}
        ...
        \input{chapters/modelli-nucleari.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\appendix
