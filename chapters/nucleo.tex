...
Tale espressione chiarisce che la sezione d'urto differenziale di diffusione rispetto all'angolo solido è data dal
...
di diffusione in funzione del profilo (vedi Appendice A).
\begin{equation}
...
\end{gather*}
ma $|1 - \Gamma|^2 = 1 + |\Gamma|^2 - 2 \Re \Gamma$ e dunque si perviene alle espressioni della sezione d'urto totale
di assorbimento in funzione del profilo \begin{equation}
