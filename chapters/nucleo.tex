...
piana dovrà comunque avere la seguente semplice espressione\sidenote{L'utilizzo
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Teoria della diffrazione di Kirchhoff}\label{sec:teoria-della-diffrazione-di-kirchhoff}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Sulla base di queste considerazioni si potrà costruire un esperimento
...
possiamo ottenere la seguente stima di $r_0$
\begin{gather*}
...
\end{gather*}
Il valore meglio compatibile con i dati sperimentali oggi disponibili fornisce $ r_0 = 1.24\, fm$.
...
la sezione d'urto differenziale di scattering sarà data dalla espressione (\ref{eq:scattering-differential-cross-section-absorptive-disk})
\[
...
delle sezioni d’urto di scattering misurate che, pur avendo dei minimi pronunciati, non si annullano mai (vedi figura).
...
La via della \emph{fusione nucleare} è stata scelta dalle stelle.
